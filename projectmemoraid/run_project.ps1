...
Write-Host "`n[1/4] Checking for Redis..." -ForegroundColor Yellow
...
Write-Host "[2/4] Starting Django Backend..." -ForegroundColor Yellow
...
Write-Host "[3/4] Starting Vite Frontend..." -ForegroundColor Yellow
...
Write-Host "[4/4] Starting Celery Services..." -ForegroundColor Yellow
